...
nationalityGroup.append(createLabel("nationality","Nationality"),
createInput("text",
      "nationality",
      "nationality",
...
majorCol.append(createLabel("study", "Major/Field of study"), 
...
gpaCol.append(createLabel("gpa","Current GPA"), 
...
schoolCol.append(createLabel("school","Previous School"),
...
emailCol.append(createLabel("email","Email Address"),
...
phoneCol.append(createLabel("phone","Phone Number"),
...
streetGroup.append(createLabel("street","Street Address"),
...
cityCol.append(createLabel("city","City"),
...
stateCol.append(createLabel("state","State/Province"),
...
pinGroup.append(createLabel("pin","Zip/Postal code"),
...
photoCol.append(createLabel("photo","Profile Photo"),
...
transcriptCol.append(createLabel("transcript","Academic Transcript"),
createInput("file","transcript","transcript","Choose file no file selected"),
...
const index= state.students.findIndex((student) => student.id === state.editingId);
...
function showErrors(errors: Record<string,string>){     //Record<string,string> means: Key type = string,Value type = string
